...
/**
 * Gera HTML formatado para email de boas-vindas
 */
...
<body>
  ...
  <div class="content">
    ...
    <p>Seu email foi cadastrado com sucesso no sistema <strong>Controle de Máquina</strong>!</p>

    <div class="info-box">
      <h3 style="margin-top: 0;">📧 O que você receberá:</h3>
      <div class="feature">
        <strong>🕘 Notificações Diárias às 21h</strong><br/>
        Você receberá um email consolidado com todos os alertas críticos do dia
      </div>
      <div class="feature">
        <strong>🚨 Alertas Críticos</strong><br/>
        Manutenções atrasadas ou próximas do vencimento
      </div>
      <div class="feature">
        <strong>⛽ Tanque de Combustível</strong><br/>
        Avisos quando o nível estiver baixo
      </div>
      <div class="feature">
        <strong>📊 Máximo 1 Email por Dia</strong><br/>
        Você não receberá múltiplos emails do mesmo alerta
      </div>
    </div>

    <p style="background-color: #FFF3E0; padding: 12px; border-left: 4px solid #FF9800; border-radius: 4px;">
      <strong>📌 Importante:</strong> Os emails serão enviados automaticamente <strong>apenas quando houver alertas críticos</strong>. Se não houver alertas, você não receberá emails.
    </p>

    <p>Obrigado por usar o Controle de Máquina!</p>
  </div>
...
/**
 * Envia email de boas-vindas quando um novo email é cadastrado
 */
export async function sendWelcomeEmail(
  ...
  const subject = '✅ Email Cadastrado - Controle de Máquina';
